(function () {
  ...
  return {
    ...
    map: {
      ...
      tools: {
        buffer: {
          url: 'https://gis.phila.gov/arcgis/rest/services/Geometry/GeometryServer/buffer'
        },
        distance: {
          url: 'https://gis.phila.gov/arcgis/rest/services/Geometry/GeometryServer/distance'
        }
      }
    },
    carto: {
